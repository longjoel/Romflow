...
var RomFlowJS = (function () {
    ...
    return {
        ...
        including gamepad input being sent, or an emulator being closed.
        ...
        */
        ...
        HOST: {
            ...
            NavigateUp: function () {
                if (typeof (_callbacks.NavigateUp) == 'function')
                    _callbacks.NavigateUp();
            },

            NavigateDown: function () {
                if (typeof (_callbacks.NavigateDown) == 'function')
                    _callbacks.NavigateDown();
            },


            NavigateLeft: function () {
                if (typeof (_callbacks.NavigateLeft) == 'function')
                    _callbacks.NavigateLeft();
            },


            NavigateRight: function () {
                if (typeof (_callbacks.NavigateRight) == 'function')
                    _callbacks.NavigateRight();
            },


            NavigateForward: function () {
                if (typeof (_callbacks.NavigateForward) == 'function')
                    _callbacks.NavigateForward();
            },


            NavigateBackward: function () {
                if (typeof (_callbacks.NavigateBackward) == 'function')
                    _callbacks.NavigateBackward();
            },


            OnEmulatorExit: function () {
                if (typeof (_callbacks.OnEmulatorExit) == 'function')
                    _callbacks.OnEmulatorExit();
            }
        ...
        CLIENT: {
            ...
            */
            GetEmulators: function () {
                return window.external.GetEmulators()
          .split('|');
            },
            ...
            */
            GetRoms: function (emulatorName) {
                return window.external.GetRoms(emulatorName)
          .split('|');
            },
            ...
            */
            ...
            /*
            Registers a gamepad callback to the host application.
            ...
            */
            ...
            /*
            Enumerate the game pads, usefull for debugging a theme.
            */
            ...
            /*
            Get the state of a gamepad as a string. Usefull for debugging.
            */
